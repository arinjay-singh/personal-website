    ...
    <div className=" flex flex-col h-screen justify-center" id="introduction">
      <div className="flex flex-row">
        <div className="flex flex-col items-start justify-center pt-20 ml-36">
          <h2 className=" font-medium text-4xl py-1">Hi, my name is</h2>
          <h1 className=" font-bold text-8xl text-cyan-600 py-1">
            Arinjay Singh.
          </h1>
          <h3 className=" font-medium text-3xl py-2 text-balance">
            ...
            sociotechnical artificial intelligence systems.
          </h3>
        </div>
        <Image src={memoji} width={400} height={400} alt="Memoji" className="mr-36"/>
      </div>
